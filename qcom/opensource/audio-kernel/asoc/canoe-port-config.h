...
static struct port_params wsa_frame_params_default_legacy[SWR_MSTR_PORT_LEN_LEGACY] = {
...
static struct port_params wsa_frame_params_receiver_legacy[SWR_MSTR_PORT_LEN_LEGACY] = {
...
static struct port_params rx_frame_params_dsd_legacy[SWR_MSTR_PORT_LEN_LEGACY] = {
...
static struct port_params rx_frame_params_default_legacy[SWR_MSTR_PORT_LEN_LEGACY] = {
	{3,     0,    0,    0xFF, 0xFF, 1,    0xFF, 0xFF, 1,    0x00, 0x00}, /* HPH/EAR */
	{63,    0,    0,    3,    6,    7,    0,    0xFF, 0,    0x00, 0x02}, /* HPH_CLH */
	{31,    11,   11,   0xFF, 0xFF, 4,    1,    0xFF, 0,    0x00, 0x02}, /* HPH_CMP */
	{7,     1,    0,    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0,    0x00, 0x00}, /* LO/AUX */
...
static struct port_params rx_frame_params_44p1KHz_legacy[SWR_MSTR_PORT_LEN_LEGACY] = {
	{3,     0,    0,    0xFF, 0xFF, 1,    0xFF, 0xFF, 1,    0x00, 0x00}, /* HPH/EAR */
	{63,    0,    0,    3,    6,    7,    0,    0xFF, 0,    0x00, 0x02}, /* HPH_CLH */
	{31,    11,   11,   0xFF, 0xFF, 4,    1,    0xFF, 0,    0x00, 0x02}, /* HPH_CMP */
	{3,     1,    0,    0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0,    0x00, 0x00}, /* LO/AUX */
...
static struct swr_mstr_port_map sm_rx_port_map_legacy[] = {
	{RX_MACRO, SWR_UC0, rx_frame_params_default_legacy},
	{RX_MACRO, SWR_UC1, rx_frame_params_dsd_legacy},
	{RX_MACRO, SWR_UC2, rx_frame_params_44p1KHz_legacy},
};

static struct swr_mstr_port_map sm_wsa_port_map_legacy[] = {
	{WSA_MACRO, SWR_UC0, wsa_frame_params_default_legacy},
	{WSA_MACRO, SWR_UC1, wsa_frame_params_receiver_legacy},
};
