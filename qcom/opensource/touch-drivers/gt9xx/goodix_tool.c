...
{
	scnprintf(procname, 20, "gmnode"); /* modify for moto */
}
...
{
	/* if (!strcmp(IC_TYPE, "GT818")
	 *  || !strcmp(IC_TYPE, "GT816")
	 *  || !strcmp(IC_TYPE, "GT811")
	 *  || !strcmp(IC_TYPE, "GT818F")
	 *  || !strcmp(IC_TYPE, "GT827")
	 *  || !strcmp(IC_TYPE,"GT828")
	 *  || !strcmp(IC_TYPE, "GT813"))
	 */
