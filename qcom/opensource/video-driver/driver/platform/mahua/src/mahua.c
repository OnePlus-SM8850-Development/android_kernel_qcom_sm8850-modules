...
static int msm_vidc_set_ring_buffer_count_mahua(void *instance,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_mahua[] = {
	...
	{ENC_RING_BUFFER_COUNT, ENC, H264,
		{0},
		NULL,
		msm_vidc_set_ring_buffer_count_mahua},
...
/* name */
static const char * const mahua_opp_pd_table[] = { "mxc", "mmcx", NULL };
...
static const struct msm_vidc_platform_data mahua_data = {
	...
	.opp_tbl = mahua_opp_pd_table,
	.opp_tbl_size = ARRAY_SIZE(mahua_opp_pd_table),
...
static int msm_vidc_mahua_check_ddr_type(void)
{
	return 0;
}
